...
const SET_CREATE_PERSON_VISIBLE = 'REMEMBER_ME/SET_CREATE_PERSON_VISIBLE';
const CREATE_PERSON = 'REMEMBER_ME/CREATE_PERSON';
const PERSON_CREATED = 'REMEMBER_ME/PERSON_CREATED';
const ACKNOWLEDGE_PERSON_CREATED = 'REMEMBER_ME/ACKNOWLEDGE_PERSON_CREATED';
const UNDO_PERSON_CREATED = 'REMEMEBER_ME/UNDO_PERSON_CREATED';
const SET_EDIT_PERSON_VISIBLE = 'REMEMBER_ME/SET_EDIT_PERSON_VISIBLE';
const EDIT_PERSON = 'REMEMBER_ME/EDIT_PERSON';
const PERSON_EDITED = 'REMEMBER_ME/PERSON_EDITED';
const ACKNOWLEDGE_PERSON_EDITED = 'REMEMBER_ME/ACKNOWLEDGE_PERSON_EDITED';
const SET_DELETE_PERSON_VISIBLE = 'REMEMBER_ME/SET_DELETE_PERSON_VISIBLE';
const DELETE_PERSON = 'REMEMBER_ME/DELETE_PERSON';
const PERSON_DELETED = 'REMEMBER_ME/PERSON_DELETED';
const ACKNOWLEDGE_PERSON_DELETED = 'REMEMBER_ME/ACKNOWLEDGE_PERSON_DELETED';
